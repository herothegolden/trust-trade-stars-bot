...
INTRO = (
    ...
    "• No document verifications\n\n"
    "✅ *Verified Member* — 550⭐/month\n"
    "• Up to 2 verifications/day\n"
    "• Verified group access\n"
    "• Priority support\n\n"
    "⭐ *Pro Member* — 1,500⭐/month\n"
    "• Up to 7 verifications/day\n"
    "• Pro group access\n"
    "• Enhanced priority support\n\n"
    "💎 *VIP Member* — 5,000⭐/month\n"
    "• Up to 10 verifications/day\n"
    "• VIP group access\n"
    "• Premium support\n\n"
    "👑 *The Oil King* — 300,000⭐/month\n"
